    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{center}
                TurboSpectrum v20 
                \begin{itemize}
                    \item [-] résoud l'équation de transfert radiatif avec méthode Feautrier
                    \item [-] à la fois dans l'apporixmation LTE et non-LTE
                    \item [-] à la fois pour pour la géométrie plan-parallel (log g $<$ 3.5) et sphérique (log g $>$ 3.5)
                \end{itemize}
            \end{center}
        \end{column}
        \begin{column}{0.5\textwidth}
