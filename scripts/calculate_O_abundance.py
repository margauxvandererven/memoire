...
def calculate_O_abu(iteration, ABU):
    with open('../data_lines/raies_moleculaires_test.txt', 'r') as f:
        data = json.load(f)
    raies=data["OH_lines"]

    analyse_chi2(raies, ABU, "O",stardata,lines_BD22,minimisation=True, abu_to_plot=None,plot=None, name=None,save=f"chi_OH_{iteration}")
